...
- Orders API endpoints:
  - Changed the `list` method to `listByCustomer`
  - Add `list` method to get a list of orders

## [1.0.0-beta.31] - 2025-05-29

### Changed

- Removed default params from the carts API's remove endpoint

## [1.0.0-beta.30] - 2025-05-27
